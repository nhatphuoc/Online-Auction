...
public interface ProductRepository extends JpaRepository<Product, Long>, JpaSpecificationExecutor<Product> {
        ...
        @Query("SELECT p FROM Product p WHERE p.currentBidder = :bidderId AND p.endAt <= :now ORDER BY p.endAt DESC")
        Page<Product> findByHighestBidderAndEnded(@Param("bidderId") Long bidderId,
                        @Param("now") LocalDateTime now,
                        Pageable pageable);
}
